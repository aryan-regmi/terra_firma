...
fn display_main_screen(mut egui_ctxs: EguiContexts, mut ui_state: ResMut<UiState>) {
...
fn switch_to_gameplay_screen(mut next_state: ResMut<NextState<Screen>>, ui_state: Res<UiState>) {
